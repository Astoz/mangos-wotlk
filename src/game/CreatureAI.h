...
class MANGOS_DLL_SPEC CreatureAI
{
    public:
         ...
         */
        void SendAIEvent(AIEventType eventType, Unit* pInvoker, uint32 uiDelay, float fRadius);
         ...
         */
        void SendAIEvent(AIEventType eventType, Unit* pInvoker, Creature* pReceiver)
        {
        ...
        {
            // debug:
            std::string text = "Debug Test, Receive Event";
            m_creature->MonsterSay(text.c_str(), 0);
        };
